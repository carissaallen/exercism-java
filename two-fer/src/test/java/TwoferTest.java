...
public class TwoferTest {
    ...
    @Test
    public void aHyphenatedNameGiven() {
        String input = "Cora-lee";
        String expected = "One for Cora-lee, one for me.";

        assertEquals(expected, twofer.twofer(input));
    }

    @Test
    public void aLowercaseNameGiven() {
        String input = "sammy";
        String expected = "One for Sammy, one for me.";
